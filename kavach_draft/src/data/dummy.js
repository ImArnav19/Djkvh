...
export const EditorData = () => (
  <div>
    <h3>
      A mesh network is a type of networking topology in which each device, often called a node, is connected directly to every other node. This creates a decentralized and self-healing network structure that can provide robust coverage, improved reliability, and increased scalability compared to traditional linear or star topologies. Mesh networks are commonly used in various scenarios, including wireless communication, IoT Internet of Things, and even wired networks in certain cases.
    </h3>
  </div>
);
...
export const weeklyStats = [
  ...
  },
  {
    icon: <BsChatLeft />,
    amount: 'Active',
    title: 'Vulnerable Client Assessment',
    desc: 'Ample Admin',
    iconBg: '#00C292',
    pcColor: 'green-600',
  },
...
export const ordersData = [
  {
    ...
    SSID: 'TG862G12',
    RSSI: '40',
    MACAddress: '00:1D:D5:DC:02:10',
    Devices: 'Jupiter Router',
    Location: 'USA',
    Status: 'pending',
    StatusBg: '#FB9678',
    ProductImage:
